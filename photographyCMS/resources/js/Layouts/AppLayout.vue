          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <NavLink :href="route('user.photos.index', $page.props.auth.user.id)" :active="route().current('user.photos.index',[$page.props.auth.user.id])">
                  My Photos
                </NavLink>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
              <div class="ml-3 relative">
                <template v-if="$page.props.role.is.admin || $page.props.role.is['Super-Admin']">
